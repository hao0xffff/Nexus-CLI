...
@Component
public class LinuxTerminalProfileParser implements TerminalProfileParser {
    @Override
    public boolean supports(SystemInspector.OSType osType) {
        return osType == SystemInspector.OSType.LINUX;
    }
    ...
    public String formatCompactCommandGuide(TerminalProfile profile) {
        return "Linux: ls, cd, cat, grep, ps, kill, find, chmod, systemctl.";
    }
